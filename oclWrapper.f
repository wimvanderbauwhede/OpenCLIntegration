...
!            array1d = reshape(array,shape(array1d))
        ...
        subroutine oclWrite1DBuffer(buffer, sz1d,array)
            integer(8):: buffer
            integer :: sz1d
            real, dimension(sz1d) :: array
            sz1d=size(array)*4 ! x4 because float is 4 bytes
            call oclwritebufferc(ocl,buffer, sz1d,array)
        end subroutine
...
!            array1d = reshape(array,shape(array1d))
        ...
        subroutine oclRead1DBuffer(buffer,sz1d,array1d)
            integer(8):: buffer
            integer :: sz1d
        ...
        subroutine oclRead2DBuffer(buffer,sz,array)
            integer(8):: buffer
            integer :: sz1d
        ...
        subroutine oclRead3DBuffer(buffer,sz,array)
            integer(8):: buffer
            integer :: sz1d
            integer, dimension(3):: sz
            real,dimension(sz(1),sz(2),sz(3)) :: array
        ...
        subroutine oclRead4DBuffer(buffer,sz,array)
            integer(8):: buffer
            integer :: sz1d
