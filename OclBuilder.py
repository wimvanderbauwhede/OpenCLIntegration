...
#            env.Append(LIBS=['OclWrapper'])
        ...
        if plat=='AMD':
            ...
            env.Append(LIBPATH=['/usr/lib64',ALTERA_SDK_PATH+'/host/linux64/lib',ALTERA_SDK_PATH+'/board/nalla_pcie/linux64/lib',os.environ['AOCL_BOARD_PACKAGE_ROOT']+'/linux64/lib'])
